...
An artist begins with an Idea, a schematic approximation of a perfect and fully determined Form. The Idea is then rendered as an Instance, the work itself, which is also an approximation of the Form: now fully determined now, imperfect and distorted. An approximation of an approximation.
