...
# The blog: per-post h-entry permalink pages + an h-feed index, generated by
# posts.py (which writes posts/<slug>/index.html as a side effect). Rebuilds
# when any post or shared template/script changes.
blog: $(OUTDIR)/blog/index.html

$(OUTDIR)/blog/index.html: posts.py render.py common.py $(POSTS) \
...
dev:
	...
	printf '%s\n' posts.py render.py templates/post.html.in templates/blog.html.in templates/_head.html templates/_footer.html templates/styles.css $(POSTS) | entr make $(OUTDIR)/blog/index.html & \
